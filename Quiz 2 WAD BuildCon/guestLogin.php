                ...
                <div class="row">
                    <div class="col-sm-12 col-md-10 mx-auto bg-white rounded shadow">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <form class="m-5">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" id="username" name="guest_email" />
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" for="password">Password</label>
                                        <input class="form-control" type="password" id="password" name="guest_password" />
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-6">
                            ...
                            <div class="col-md-6">
                                <div>
                                    <img src="img/guest.svg" alt="login" class="img-fluid p-5" />
                                </div>
                            </div>
                        </div>
                    </div>
